...
import Views.Utils exposing (decimalInput, disableGrammarly, emailInput, icon, labelView, pageOverlay, pageTitleView, rawHtml)
    ...
    let
        newAccountAlert =
            if not guest then
                ...
                div [ class "alert alert-info clearfix d-flex justify-content-between" ]
                    [ text <|
                        String.join " "
