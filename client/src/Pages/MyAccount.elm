    ...
    let
        ...
        desktopView =
            table [ class "se-table tw:hidden tw:lg:block" ]
                [ thead []
                    [ tr []
                        [ th [ class "tw:whitespace-nowrap" ] [ text "Date" ]
                        , th [ class "tw:whitespace-nowrap" ] [ text "Order #" ]
                        , th [ class "tw:w-full" ] [ text "Shipping Address" ]
                        , th [ class "tw:whitespace-nowrap" ] [ text "Order Status" ]
                        , th [ class "tw:whitespace-nowrap" ] [ text "Total" ]
                        , th [] []
                        ]
                    ]
