module Views.ShippingAdmin exposing (Form, Msg, getShippingMethods, initialForm, update, view)
...
import Locations exposing (Location)
import Models.Fields exposing (Cents, centsDecoder, centsEncoder, centsToString)
import PageData
import Ports
...
import Views.Admin as Admin exposing (categorySelects, formSavingClass, multiSelect)
