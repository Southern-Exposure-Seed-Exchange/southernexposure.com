...
module.exports = {
  ...
  plugins: [
    ...
    new CspHtmlWebpackPlugin({
      ...
      'object-src': "'none'",
      'connect-src': ["'self'", "https://checkout.stripe.com", "https://api.helcim.app", ],
      'frame-src': ["'self'", "https://checkout.stripe.com", "https://www.farmraiser.com", "https://secure.helcim.app"],
